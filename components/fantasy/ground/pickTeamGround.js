            ...
            <div className = "x-transfer-player-ground">
                ...
                <Grid container className = "x-ground-img" style = {mobile?{height: `${imgHeight}px`}:{height:`${imgHeight-220}px`, paddingTop: "10%"}}>
                    ...
                    <Grid item xs = {4} sm = {4} md = {4}>
                        ...
                        <img src={`/img/shirts/${main&&main[0][7]}/keeper.png`} className = "x-player-body" width = {mobile?`${imgHeight/11}`:"40px"}   onClick = {(e)=>removePlayer(e,0,true)}/>
                    ...
                    <Grid item xs = {3} sm = {3} md = {3}>
                        ...
                        <img src={`/img/shirts/${main&&main[1][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>removePlayer(e,1)}/>
                        {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                            <InfoIcon />
                        </IconButton> */}
                        <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                    ...
                    <Grid item xs = {3} sm = {3} md = {3}>
                        ...
                        <img src={`/img/shirts/${main&&main[2][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>removePlayer(e,2)}/>
                        {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                            <InfoIcon />
                        </IconButton> */}
                        <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                    ...
                    <Grid item xs = {3} sm = {3} md = {3}>
                        ...
                        <img src={`/img/shirts/${main&&main[3][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>removePlayer(e,3)}/>
                        {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                            <InfoIcon />
                        </IconButton> */}
                        <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                    ...
                    <Grid item xs = {3} sm = {3} md = {3}>
                        ...
                        <img src={`/img/shirts/${main&&main[4][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>removePlayer(e,4)}/>
                        {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                            <InfoIcon />
                        </IconButton> */}
                        <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                    ...
                    <Grid item xs = {3} sm = {3} md = {3}>
                        ...
                        <img src={`/img/shirts/${main&&main[5][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>removePlayer(e,5)}/>
                        {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                            <InfoIcon />
                        </IconButton> */}
                        <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                    ...
                    <Grid item xs = {3} sm = {3} md = {3}>
                        ...
                        <img src={`/img/shirts/${main&&main[6][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>removePlayer(e,6)}/>
                        {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                            <InfoIcon />
                        </IconButton> */}
                        <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                    ...
                    <Grid item xs = {3} sm = {3} md = {3}>
                        ...
                        <img src={`/img/shirts/${main&&main[7][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>removePlayer(e,7)}/>
                        {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                            <InfoIcon />
                        </IconButton> */}
                        <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                    ...
                    <Grid item xs = {3} sm = {3} md = {3}>
                        ...
                        <img src={`/img/shirts/${main&&main[8][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>removePlayer(e,8)}/>
                        {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                            <InfoIcon />
                        </IconButton> */}
                        <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                    ...
                    <Grid item xs = {3} sm = {3} md = {3}>
                        ...
                        <img src={`/img/shirts/${main&&main[9][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>removePlayer(e,9)}/>
                        {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                            <InfoIcon />
                        </IconButton> */}
                        <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                    ...
                    <Grid item xs = {3} sm = {3} md = {3}>
                        ...
                        <img src={`/img/shirts/${main&&main[10][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>removePlayer(e,10)}/>
                        {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                            <InfoIcon />
                        </IconButton> */}
                        <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                ...
                <Grid container className = "text-center mt-4">
                  <Grid item xs = {3} sm = {3} md = {3}>
                      ...
                      <img src={`/img/shirts/${candidate&&candidate[0][7]}/keeper.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>addPlayer(e,0)}/>
                      {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                          <InfoIcon />
                      </IconButton> */}
                      <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                  ...
                  <Grid item xs = {3} sm = {3} md = {3}>
                    ...
                    <img src={`/img/shirts/${candidate&&candidate[1][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>addPlayer(e,1)}/>
                    {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                        <InfoIcon />
                    </IconButton> */}
                    <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                  ...
                  <Grid item xs = {3} sm = {3} md = {3}>
                    ...
                    <img src={`/img/shirts/${candidate&&candidate[2][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>addPlayer(e,2)}/>
                    {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                        <InfoIcon />
                    </IconButton> */}
                    <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
                  ...
                  <Grid item xs = {3} sm = {3} md = {3}>
                    ...
                    <img src={`/img/shirts/${candidate&&candidate[3][7]}/other.png`} className = "x-player-body" width = {mobile?`${imgHeight/10}`:"40px"}   onClick = {(e)=>addPlayer(e,3)}/>
                    {/* <IconButton className = "x-player-remove-button" style = {mobile?{display: "none"}:null}>
                        <InfoIcon />
                    </IconButton> */}
                    <div className = "x-transfer-player-info-name" style = {mobile?{fontSize: "9px"}:{fontSize: "11px"}}>
